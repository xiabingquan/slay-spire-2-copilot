...
按角色卡池分区的全卡清单——经验列待填。卡牌数据：`spirectl lookup <id>`。
...
| id | 名称 | 经验 |
|---|---|---|
| ASCENDERS_BANE | 攀登者之祸 |  |
| BAD_LUCK | 厄运 |  |
| CLUMSY | 笨拙 |  |
| CURSE_OF_THE_BELL | 丧钟之咒 |  |
| DEBT | 债务 |  |
| DECAY | 衰败 |  |
| DOUBT | 怀疑 |  |
| ENTHRALLED | 着迷 |  |
