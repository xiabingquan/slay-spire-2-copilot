...
| SYMBIOTE | 共生体 |  |
| TABLET_OF_TRUTH | 真理石板 | - (2026-09-18) 真理石板类代价事件：全阶段代价未解码前不盲选（旧教训：−21 Max HP 换零收益） |
| TANX | 远古赐福房 |  |
| TEA_MASTER | 茶艺大师 |  |
...
- (2026-09-18) 事件/剧情盲走曾致命：数据里只有一行摘要 = 未解机制——未解码选项先 lookup 再选
- (2026-09-19) 档案过时备注先用本局 live 数据证伪再采用
- (2026-09-18) boon 房是每章第一个决策面——赐福房缺失问题已修复，别因赶路跳过
