...
and finalizes on game_over. Never delete or rewrite logs/ — they are committed
to the repo as the permanent play record. The postmortem below is the summary
layer on top of that log.
