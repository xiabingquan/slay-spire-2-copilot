...
STATE_FILE="$LOG_DIR/.watchdog-last-notify"
...
# Newest run-log mtime under the active session log dir
newest_log=""
newest_mtime=0
...
Resume: invoke skill slay-spire-2-copilot with an explicit log-path." \
    "orange"
else
